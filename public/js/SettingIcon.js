      ...
      <div className='header-column-icon-wrapper setting-wrapper'>
        ...
        <Modal
          ...
          <Form>
            <Modal.Header className='pt-1 pb-1'>
              <Modal.Title>全局配置</Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <span className='text-muted'>
                这是全局配置模式。
                更改不会影响已经单独配置的符号。
                在更改配置值之前，请确保您了解设置的内容。
              </span>
                                    ...
                                    <div className='col-12'>
                                      <Form.Group
                                        ...
                                        <Form.Check size='sm'>
                                          ...
                                          />
                                          <Form.Check.Label>
                                            当信号为<code>Strong buy</code>{' '}时，允许购买。
                                            <OverlayTrigger
                                              trigger='click'
        ...
        <Modal
          ...
          <Modal.Body>
            ...
            <br />
            <br />
            您想修改所有符号的配置，还是仅保存全局配置？
            <br />
            <br />
            如果您选择申请所有符号，则自定义符号配置将被删除。
            <br />
            <br />
            如果您选择仅应用全局配置，则与全局配置不同的符号将显示为自定义。
          </Modal.Body>
